...
public class CommentListView extends LinearLayout {
    ...
    private View getView(final int position) {
        ...
        builder.append(setClickableSpan(name, String.valueOf(bean.getUser().getId())));

        if (!TextUtils.isEmpty(toReplyName)) {

            builder.append(" 回复 ");
            builder.append(setClickableSpan(toReplyName, String.valueOf(bean.getToReplyUser().getId())));
        }
        builder.append(": ");
        //转换表情字符
