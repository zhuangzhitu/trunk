package com.cassan.circlefriend.spannable;
...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = AppContext.getInstance().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor =  AppContext.getInstance().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
