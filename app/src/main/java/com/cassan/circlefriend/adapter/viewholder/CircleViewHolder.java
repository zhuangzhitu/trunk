...
import com.cassan.circlefriend.widgets.ExpandTextView;
import com.cassan.circlefriend.widgets.PraiseListView;
...
public abstract class CircleViewHolder extends RecyclerView.ViewHolder implements VideoLoadMvpView {
    ...
    public CircleViewHolder(View itemView, int viewType) {
        ...
        publictime = (TextView) itemView.findViewById(R.id.publictime);
