...
选择用户
 */
public class PickAtUserActivity extends BaseHuanxinActivity {
    ...
    protected void onCreate(Bundle arg0) {
        super.onCreate(arg0);
        setContentView(cn.cassan.pm.R.layout.activity_pick_at_user);
        String groupId = getIntent().getStringExtra("groupId");
        EMGroup group = EMClient.getInstance().groupManager().getGroup(groupId);
        EaseSidebar sidebar = (EaseSidebar) findViewById(cn.cassan.pm.R.id.sidebar);
        listView = (ListView) findViewById(cn.cassan.pm.R.id.list);
