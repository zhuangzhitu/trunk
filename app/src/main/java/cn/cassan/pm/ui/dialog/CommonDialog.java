...
public class CommonDialog extends Dialog {
    ...
    protected void init(final Context context) {
        ...
        content = LayoutInflater.from(context).inflate(
                cn.cassan.pm.R.layout.dialog_common, null);
        headerVw = (DialogTitleView) content.findViewById(cn.cassan.pm.R.id.dialog_header);
        container = (FrameLayout) content.findViewById(cn.cassan.pm.R.id.content_container);
        barDivider = content.findViewById(cn.cassan.pm.R.id.button_bar_divider);
        buttonDivider = content.findViewById(cn.cassan.pm.R.id.button_divder);
        positiveBt = (Button) content.findViewById(cn.cassan.pm.R.id.positive_bt);
        negativeBt = (Button) content.findViewById(cn.cassan.pm.R.id.negative_bt);
...
//			});
    ...
    public void setMessage(Spanned spanned) {
        ...
        TextView tvMessage = new TextView(getContext(), null,
                cn.cassan.pm.R.style.dialog_pinterest_text);
