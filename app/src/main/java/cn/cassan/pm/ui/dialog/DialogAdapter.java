    ...
    public View getView(int i, View view, ViewGroup viewgroup) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(viewgroup.getContext()).inflate(
                    cn.cassan.pm.R.layout.list_cell_dialog, null, false);
            vh.titleTv = (TextView) view.findViewById(cn.cassan.pm.R.id.title_tv);
            vh.divider = view.findViewById(cn.cassan.pm.R.id.list_divider);
            vh.checkIv = (RadioButton) view.findViewById(cn.cassan.pm.R.id.rb_select);
            view.setTag(vh);
        } else {
