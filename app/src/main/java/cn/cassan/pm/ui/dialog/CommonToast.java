    ...
    private class ToastView extends FrameLayout {
        ...
        private void init() {
            LayoutInflater.from(getContext()).inflate(
                    cn.cassan.pm.R.layout.view_base_toast, this, true);
            messageTv = (TextView) findViewById(cn.cassan.pm.R.id.title_tv);
            messageIc = (ImageView) findViewById(cn.cassan.pm.R.id.icon_iv);
            actionTv = (TextView) findViewById(cn.cassan.pm.R.id.title_tv);
            actionIv = (ImageView) findViewById(cn.cassan.pm.R.id.icon_iv);
        }
    }
}
