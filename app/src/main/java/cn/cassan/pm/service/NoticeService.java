...
import cn.cassan.pm.broadcast.AlarmReceiver;
...
//                            cn.cassan.pm.R.string.you_have_news_messages);
//                }
...
//        String contentTitle = res.getString(cn.cassan.pm.R.string.you_have_news_messages,
//                count);
//        String contentText;
//        StringBuffer sb = new StringBuffer();
//        if (atmeCount > 0) {
//            sb.append(getString(cn.cassan.pm.R.string.atme_count, atmeCount)).append(" ");
//        }
//        if (msgCount > 0) {
//            sb.append(getString(cn.cassan.pm.R.string.msg_count, msgCount)).append(" ");
//        }
//        if (reviewCount > 0) {
//            sb.append(getString(cn.cassan.pm.R.string.review_count, reviewCount))
//                    .append(" ");
//        }
//        if (newFansCount > 0) {
//            sb.append(getString(cn.cassan.pm.R.string.fans_count, newFansCount));
//        }
//        if (newLikeCount > 0) {
//            sb.append(getString(cn.cassan.pm.R.string.like_count, newLikeCount));
//        }
...
//                .setContentIntent(pi).setSmallIcon(cn.cassan.pm.R.drawable.ic_notification);
//
//        if (AppContext.get(AppConfig.KEY_NOTIFICATION_SOUND, true)) {
//            builder.setSound(Uri.parse("android.resource://"
//                    + AppContext.getInstance().getPackageName() + "/"
//                    + cn.cassan.pm.R.raw.notificationsound));
//        }
...
//                cn.cassan.pm.R.string.you_have_news_messages, notification);
//    }
