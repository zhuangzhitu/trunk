...
public abstract class am extends ReplacementSpan {
    ...
    private void d() {
        ...
        m = resources
                .getDimensionPixelSize(cn.cassan.pm.R.dimen.timeline_small_card_icon_margin_left);
        i = resources
                .getDimensionPixelSize(cn.cassan.pm.R.dimen.timeline_small_card_icon_width);
        j = resources
                .getDimensionPixelSize(cn.cassan.pm.R.dimen.timeline_small_card_icon_height);
        int i1 = resources
                .getDimensionPixelSize(cn.cassan.pm.R.dimen.timeline_small_card_triangle_margin_right);
        int j1 = resources
                .getDimensionPixelSize(cn.cassan.pm.R.dimen.timeline_small_card_triangle_margin_left);
        n = resources
                .getDimensionPixelSize(cn.cassan.pm.R.dimen.timeline_small_card_title_margin_left);
        int k1 = resources
                .getDimensionPixelSize(cn.cassan.pm.R.dimen.timeline_small_card_title_text_size);
        f = resources.getDimensionPixelSize(cn.cassan.pm.R.dimen.timeline_small_card_height);
        int l1 = resources.getColor(cn.cassan.pm.R.color.main_link_text_color);
        // a1.a(R.color.main_link_text_color);
        int i2 = resources
                .getDimensionPixelSize(cn.cassan.pm.R.dimen.timeline_small_card_min_width);
        ...
        Drawable drawable = resources
                .getDrawable(cn.cassan.pm.R.drawable.timeline_card_small_button);
        // a1.b(R.drawable.timeline_card_small_button);
        drawable.setBounds(0, 0, e, f);
        l[0] = drawable;
        Drawable drawable1 = resources
                .getDrawable(cn.cassan.pm.R.drawable.timeline_card_small_button_highlighted);
        // a1.b(R.drawable.timeline_card_small_button_highlighted);
        drawable1.setBounds(0, 0, e, f);
        l[1] = drawable1;
        if (h == null) {
            h = resources
                    .getDrawable(cn.cassan.pm.R.drawable.timeline_card_small_placeholder);
    ...
    protected int b() {
        return g.getResources().getDimensionPixelSize(
                cn.cassan.pm.R.dimen.timeline_small_card_padding_right);
    }
