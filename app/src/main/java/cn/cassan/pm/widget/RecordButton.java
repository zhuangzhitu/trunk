...
public class RecordButton extends RelativeLayout {
    ...
    private void init() {
        ...
        initSavePath();
        LayoutInflater.from(getContext()).inflate(cn.cassan.pm.R.layout.record_view, this);
        mImgDelete = (ImageView) findViewById(cn.cassan.pm.R.id.recordview_delete);
        mImgListen = (ImageView) findViewById(cn.cassan.pm.R.id.recordview_listen);
        mImgPlay = (ImageView) findViewById(cn.cassan.pm.R.id.recordview_start);
        bottomFlag = findViewById(cn.cassan.pm.R.id.recordview_text);
        topFlag = findViewById(cn.cassan.pm.R.id.recordview_layout);
        mTvRecordTime = (TextView) findViewById(cn.cassan.pm.R.id.recordview_text_time);
        mImgVolume = (ImageView) findViewById(cn.cassan.pm.R.id.recordview_img_volume);
        initPlayButtonEvent();
    }
    ...
    private void changeVolume(int volume) {
        switch (volume) {
            ...
            case 1:
            case 2:
                mImgVolume.setImageResource(cn.cassan.pm.R.drawable.audio0);
                break;
            case 3:
                mImgVolume.setImageResource(cn.cassan.pm.R.drawable.audio1);
                break;
            case 4:
                mImgVolume.setImageResource(cn.cassan.pm.R.drawable.audio2);
                break;
            case 5:
                mImgVolume.setImageResource(cn.cassan.pm.R.drawable.audio3);
                break;
        }
    }
