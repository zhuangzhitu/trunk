...
public class PagerSlidingTabStrip extends HorizontalScrollView implements
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray attrsTypedArray = context.obtainStyledAttributes(attrs,
                    cn.cassan.pm.R.styleable.PagerSlidingTabStrip);
            if (attrsTypedArray != null) {
                allowWidthFull = attrsTypedArray.getBoolean(
                        cn.cassan.pm.R.styleable.PagerSlidingTabStrip_allowWidthFull, false);
                slidingBlockDrawable = attrsTypedArray
                        .getDrawable(cn.cassan.pm.R.styleable.PagerSlidingTabStrip_slidingBlock);
                disableViewPager = attrsTypedArray.getBoolean(
                        cn.cassan.pm.R.styleable.PagerSlidingTabStrip_disableViewPager,
                        false);
    ...
    public View getBadgeView(int i) {
        return getTabsLayout().getChildAt(i).findViewById(cn.cassan.pm.R.id.tab_mes);
    }
