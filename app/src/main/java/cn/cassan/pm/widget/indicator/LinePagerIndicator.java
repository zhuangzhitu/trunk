...
public class LinePagerIndicator extends View implements PagerIndicator {
    ...
    public LinePagerIndicator(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, cn.cassan.pm.R.styleable.LinePagerIndicator);
        mCenterHorizontal = a.getBoolean(cn.cassan.pm.R.styleable.LinePagerIndicator_line_indicator_centerHorizontal, true);
        mLineWidth = a.getDimension(cn.cassan.pm.R.styleable.LinePagerIndicator_line_indicator_width, 10);
        mSpace = a.getDimension(cn.cassan.pm.R.styleable.LinePagerIndicator_line_indicator_space, 5);
        mLineHeight = a.getDimension(cn.cassan.pm.R.styleable.LinePagerIndicator_line_indicator_height, 0);
        mLineIndicatorHeight = a.getDimension(cn.cassan.pm.R.styleable.LinePagerIndicator_line_indicator_indicator_height, mLineHeight);
        mPaintFull.setColor(a.getColor(cn.cassan.pm.R.styleable.LinePagerIndicator_line_indicator_fill_color, 0x000000));
        mPaintIndicator.setColor(a.getColor(cn.cassan.pm.R.styleable.LinePagerIndicator_line_indicator_indicator_color, 0x00ff00));
        mIsFollow = a.getBoolean(cn.cassan.pm.R.styleable.LinePagerIndicator_line_indicator_follow, true);
        a.recycle();
