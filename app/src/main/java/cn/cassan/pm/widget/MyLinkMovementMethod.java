...
public class MyLinkMovementMethod extends LinkMovementMethod {
    ...
    public boolean onTouchEvent(TextView textview, Spannable spannable,
        ...
        if (i == 0) {
            ...
            if (l2 != i3) {
                aclickablespan1 = spannable.getSpans(l2, l2,
                        ClickableSpan.class);
                                ...
                                .setSpan(
                                        new BackgroundColorSpan(
                                                textview.getContext()
                                                        .getResources()
                                                        .getColor(
                                                                cn.cassan.pm.R.color.timeline_clickable_text_highlighted_background)),
            ...
            if (a == null) {
                ...
                am aam[] = spannable.getSpans(j2, j2, am.class);
            ...
            if (b == null) {
                ...
                if (i2 != layout.getOffsetForHorizontal(l1, j1 + c)) {
                    aclickablespan = spannable.getSpans(i2,
