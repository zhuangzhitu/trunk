package cn.cassan.pm.widget.indicator;
...
public class CirclePagerIndicator extends View implements PagerIndicator {
    ...
    public CirclePagerIndicator(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, cn.cassan.pm.R.styleable.CirclePagerIndicator);

        mCenterHorizontal = a.getBoolean(cn.cassan.pm.R.styleable.CirclePagerIndicator_circle_indicator_centerHorizontal, true);
        mPaintFill.setStyle(Paint.Style.FILL);
        mPaintFill.setColor(a.getColor(cn.cassan.pm.R.styleable.CirclePagerIndicator_circle_indicator_color, 0x0000ff));
        mPaintStroke.setStyle(Paint.Style.STROKE);
        mPaintStroke.setColor(a.getColor(cn.cassan.pm.R.styleable.CirclePagerIndicator_circle_indicator_stroke_color, 0x000000));
        mPaintStroke.setStrokeWidth(a.getDimension(cn.cassan.pm.R.styleable.CirclePagerIndicator_circle_indicator_stroke_width, 0));
        mPaintIndicator.setStyle(Paint.Style.FILL);
        mPaintIndicator.setColor(a.getColor(cn.cassan.pm.R.styleable.CirclePagerIndicator_circle_indicator_fill_color, 0x0000ff));
        mRadius = a.getDimension(cn.cassan.pm.R.styleable.CirclePagerIndicator_circle_indicator_radius, 10);
        mIndicatorSpace = a.getDimension(cn.cassan.pm.R.styleable.CirclePagerIndicator_circle_indicator_space, 20);
        mIndicatorRadius = a.getDimension(cn.cassan.pm.R.styleable.CirclePagerIndicator_circle_indicator_indicator_radius, 10);
        mIsFollow = a.getBoolean(cn.cassan.pm.R.styleable.CirclePagerIndicator_circle_indicator_follow, true);
