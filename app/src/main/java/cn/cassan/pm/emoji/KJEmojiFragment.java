...
public class KJEmojiFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        if (null != mRootView) {
            ...
            mRootView = (LinearLayout) inflater.inflate(cn.cassan.pm.R.layout.frag_main, container, false);
    ...
    private void initWidget(View rootView) {
        // title
        mEmojiTitle = rootView.findViewById(cn.cassan.pm.R.id.emoji_title);
        mCboxFlag = (CheckBox) mEmojiTitle.findViewById(cn.cassan.pm.R.id.emoji_title_flag);
        ...
        mEt = (EditText) mEmojiTitle.findViewById(cn.cassan.pm.R.id.emoji_titile_input);
        mCBox = (CheckBox) mEmojiTitle.findViewById(cn.cassan.pm.R.id.emoji_title_menu);
        ...
        // bottom
        mEmojiBottom = (RadioGroup) rootView.findViewById(cn.cassan.pm.R.id.emoji_bottom);
        ...
        mEmojiBottom.findViewById(cn.cassan.pm.R.id.emoji_bottom_del).setOnClickListener(
                new OnClickListener() {
                    @Override
                    public void onClick(View v) {
        ...
        mEmojiContent = (LinearLayout) rootView
                .findViewById(cn.cassan.pm.R.id.emoji_content);
        mEmojiPager = (ViewPager) mEmojiContent.findViewById(cn.cassan.pm.R.id.emoji_pager);
        ...
        if (listener != null) {
            mEmojiTitle.findViewById(cn.cassan.pm.R.id.emoji_title_send).setOnClickListener(
                    new OnClickListener() {
                        @Override
                        public void onClick(View v) {
