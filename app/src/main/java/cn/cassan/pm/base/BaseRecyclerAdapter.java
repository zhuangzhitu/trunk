...
public abstract class BaseRecyclerAdapter<T> extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            ...
            case VIEW_TYPE_FOOTER:
                return new FooterViewHolder(mInflater.inflate(cn.cassan.pm.R.layout.recycler_footer_view, parent, false));
            default:
            ...
            case VIEW_TYPE_FOOTER:
                ...
                switch (mState) {
                    case STATE_INVALID_NETWORK:
                        fvh.tv_footer.setText(mContext.getResources().getString(cn.cassan.pm.R.string.state_network_error));
                        fvh.pb_footer.setVisibility(View.GONE);
                        break;
                    case STATE_LOAD_MORE:
                    case STATE_LOADING:
                        fvh.tv_footer.setText(mContext.getResources().getString(cn.cassan.pm.R.string.state_loading));
                        fvh.pb_footer.setVisibility(View.VISIBLE);
                        break;
                    case STATE_NO_MORE:
                        fvh.tv_footer.setText(mContext.getResources().getString(cn.cassan.pm.R.string.state_not_more));
                        fvh.pb_footer.setVisibility(View.GONE);
                        break;
                    case STATE_REFRESHING:
                        fvh.tv_footer.setText(mContext.getResources().getString(cn.cassan.pm.R.string.state_refreshing));
                        fvh.pb_footer.setVisibility(View.GONE);
                        break;
                    case STATE_LOAD_ERROR:
                        fvh.tv_footer.setText(mContext.getResources().getString(cn.cassan.pm.R.string.state_load_error));
                        fvh.pb_footer.setVisibility(View.GONE);
                        break;
                    case STATE_HIDE:
    ...
    public static class FooterViewHolder extends RecyclerView.ViewHolder {
        ...
        public FooterViewHolder(View view) {
            super(view);
            pb_footer = (ProgressBar) view.findViewById(cn.cassan.pm.R.id.pb_footer);
            tv_footer = (TextView) view.findViewById(cn.cassan.pm.R.id.tv_footer);
        }
    }
