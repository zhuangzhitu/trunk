        ...
        if (message != null && !message.equalsIgnoreCase("")) {
            ...
            if (!message.equalsIgnoreCase(lastToast)
                ...
                View view = LayoutInflater.from(context()).inflate(
                        cn.cassan.pm.R.layout.view_toast, null);
                ((TextView) view.findViewById(cn.cassan.pm.R.id.title_tv)).setText(message);
                if (icon != 0) {
                    ((ImageView) view.findViewById(cn.cassan.pm.R.id.icon_iv))
                            .setImageResource(icon);
                    view.findViewById(cn.cassan.pm.R.id.icon_iv)
